...
public func ShowLoaderWithMessage(message:String) {
    startActivityAnimating(size: CGSize(width:56, height:56), message: message, type: NVActivityIndicatorType.ballClipRotate, color: APP_ORANGE_COLOR, padding: 2,isFromOnView: false)
}
...
public func SHOW_CUSTOM_LOADER() {
    startActivityAnimating(size: CGSize(width:56, height:56), message: nil, type: NVActivityIndicatorType.lineScaleParty, color: APP_ORANGE_COLOR, padding: 2,isFromOnView: false)
}
...
public func ShowLoaderOnView() {
    startActivityAnimating(size: CGSize(width:56, height:56), message: nil, type: NVActivityIndicatorType.lineScaleParty, color: APP_ORANGE_COLOR, padding: 2,isFromOnView: true)
}
